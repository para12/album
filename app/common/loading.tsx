...
export default function LoadingBackground() {
  const { loadingBg } = useContext(MainContext);
  return (
    <>
      {loadingBg && (
        <div className="fixed top-0 left-0 w-screen h-screen flex items-center justify-center z-50 bg-white animate-bgColorOut">
          <div className="flex">
            <svg
